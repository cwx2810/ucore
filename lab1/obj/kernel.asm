...
debuginfo_eip(uintptr_t addr, struct eipdebuginfo *info) {
  ...
  100550:	c7 45 f0 a8 b4 10 00 	movl   $0x10b4a8,-0x10(%ebp)
    stabstr = __STABSTR_BEGIN__;
  100557:	c7 45 ec a9 b4 10 00 	movl   $0x10b4a9,-0x14(%ebp)
    stabstr_end = __STABSTR_END__;
  10055e:	c7 45 e8 94 d4 10 00 	movl   $0x10d494,-0x18(%ebp)
...
read_ebp(void) {
  ...
  10099b:	8b 45 e0             	mov    -0x20(%ebp),%eax
	...
	//in stack order:1.args*4  2.return  3.ebp
	uint32_t ebp=read_ebp(),eip=read_eip();//read ebp and eip
  10099e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  1009a1:	e8 d9 ff ff ff       	call   10097f <read_eip>
  1009a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int i,j;//announce i and j
	for(i=0;i<STACKFRAME_DEPTH && ebp!=0;i++){//the stack's depth
  1009a9:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  1009b0:	e9 88 00 00 00       	jmp    100a3d <print_stackframe+0xad>
		cprintf("ebp:0x%08x eip:0x%08x args:",ebp,eip);//print
  ...
  1009ca:	e8 43 f9 ff ff       	call   100312 <cprintf>
		uint32_t *args=(uint32_t *)ebp+2;//find args
  ...
  1009df:	eb 25                	jmp    100a06 <print_stackframe+0x76>
			cprintf("0x%08x ",args[j]);//print 4 args
  ...
  100a13:	e8 fa f8 ff ff       	call   100312 <cprintf>
		print_debuginfo(eip-1);//print the ebp before ebp
...
idt_init(void) {
  ...
  101802:	83 ec 10             	sub    $0x10,%esp
      ...
      */
	extern uintptr_t __vectors[];//announce the entry of IDT
	int i;
  ...
  1018dc:	0f 86 2f ff ff ff    	jbe    101811 <idt_init+0x12>
		SETGATE(idt[i],0,GD_KTEXT,__vectors[i],DPL_KERNEL);
	}//init IDT,include idt[],istrap,selector,vectors,kernel/user
	SETGATE(idt[T_SWITCH_TOK],0,GD_KTEXT,__vectors[T_SWITCH_TOK],DPL_USER);//switch kernel to user
...
trap_dispatch(struct trapframe *tf) {
  ...
  101d04:	00 
  101d05:	c7 44 24 04 ad 00 00 	movl   $0xad,0x4(%esp)
  101d0c:	00 
  ...
  101d3c:	00 
  101d3d:	c7 44 24 04 b7 00 00 	movl   $0xb7,0x4(%esp)
  101d44:	00 
